...
class TUPSChecklistPage extends StatefulWidget {
  @override
  _TUPSChecklistPageState createState() => _TUPSChecklistPageState();
}

class _TUPSChecklistPageState extends State<TUPSChecklistPage> {
  final _upsu1NumberController = TextEditingController(text: 'UPS-400kva');
  //final _upsu1unitController = TextEditingController(text: 'Unit 4');
  final _upsu1dateController = TextEditingController();
  final _upsu1timeController = TextEditingController();
  final _upsu1branchController = TextEditingController(text: 'THUSMA');
  ...
  Future<void> _handleSubmit() async {
    ...
    await MongoDatabase.insert(checklistData, 'UPS Checklist');
