          ...
          child: Container(
            ...
            child: Center(
              child: Column(
                ...
                children: <Widget>[
                  Image.asset(
                    'assets/png_images/controlpanel.png', // Replace with your custom icon path
                    height: 100.0,
                  ),
                  ...
                  ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => cn1Page()),
                      );
                    },
                    ...
                    child: Text('Control Panel-UNIT 1'),
                  ),
                  SizedBox(height: 20.0),
                  ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => cn2Page()),
                      );
                    },
                    style: ElevatedButton.styleFrom(
                      backgroundColor: Colors.lightGreen,
                    ...
                    child: Text('Control Panel-UNIT 2'),
                  ),
                  SizedBox(height: 20.0),
                  ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => cn3Page()),
                      );
                    },
                    style: ElevatedButton.styleFrom(
                      backgroundColor: Colors.lightGreen,
                    ...
                    child: Text('Control Panel-UNIT 3'),
                  ),
                ],
              ),
            ),
