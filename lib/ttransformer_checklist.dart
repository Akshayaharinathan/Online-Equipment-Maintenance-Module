...
class TChecklistPage extends StatefulWidget {
  @override
  _TChecklistPageState createState() => _TChecklistPageState();
}

class _TChecklistPageState extends State<TChecklistPage> {
  final _transformerNumberController = TextEditingController(text: 'Transformer-800KVA');
  ...
  final _remarksControllers =
      List<TextEditingController>.generate(14, (_) => TextEditingController());
  ...
  final List<String> checklistTitles = [
    ...
    'Check Transformer HV Bushings',
    'Chck Transformer LV Bushings',
  ...
  Future<void> _handleSubmit() async {
    ...
    final checklistData = {
      'Rating': _transformerNumberController.text,
      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              _buildTextField(
                  _transformerNumberController, 'Rating',
                  readOnly: true),
