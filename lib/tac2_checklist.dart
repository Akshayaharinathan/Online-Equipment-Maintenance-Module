...
class Tac2ChecklistPage extends StatefulWidget {
  @override
  _Tac2ChecklistPageState createState() => _Tac2ChecklistPageState();
}

class _Tac2ChecklistPageState extends State<Tac2ChecklistPage> {
  final _acNumberController = TextEditingController(text: 'Air Chiller 1');
  final _acUnitController = TextEditingController(text: 'China');
