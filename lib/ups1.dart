...
import 'UPSU1_checklist.dart';
import 'UPSU1_measurement.dart';




class UPSU1 extends StatelessWidget {
  @override
                ...
                children: <Widget>[
                  ...
                  ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => UPSU1ChecklistPage()),
                      );
                    },
                  ...
                  ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => UPSU1MeasurementPage()),
                      );
                    },
                    style: ElevatedButton.styleFrom(
                      backgroundColor: Colors.lightGreen,
