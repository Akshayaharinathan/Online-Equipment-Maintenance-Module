...
class Generator2MeasurementPage extends StatefulWidget {
  @override
  _Generator2MeasurementPageState createState() =>
      _Generator2MeasurementPageState();
}

class _Generator2MeasurementPageState extends State<Generator2MeasurementPage> {
...
void dispose() {
  ...
  Future<void> _handleSubmit() async {
    try {
      ...
      await MongoDatabase.insert(measurementData, 'Generator 2 Measurement');
          ...
          child: Column(
            ...
            children: [
              ...
              _buildTextField(_GeneratorNumberController, 'Generator Number',
                  readOnly: true),
              _buildTextField(_genm1unitController, 'Old', readOnly: false),
