...
class TGeneratorMeasurementPage extends StatefulWidget {
  @override
  _TGeneratorMeasurementPageState createState() =>
      _TGeneratorMeasurementPageState();
}

class _TGeneratorMeasurementPageState extends State<TGeneratorMeasurementPage> {
  final _GeneratorNumberController =
      TextEditingController(text: 'Generator-600kva');
  ...
  final _genm1branchController = TextEditingController(text: 'THUSMA');
  ...
  Future<void> _handleSubmit() async {
    try {
      ...
      await MongoDatabase.insert(measurementData, 'Generator Measurement');
      ...
      children: [
        Row(
          children: [
            ...
            _buildTableCell(_genm1totalControllers[0],0,'null'),
          ],
        ),
        Row(
          children: [
            _buildTableHeaderCell('Total Kwh Generated'),
            _buildTableCell(_genm1totalControllers[1],1,'null'),
          ],
        ),
        Row(
          children: [
            _buildTableHeaderCell('Diesel Consumption'),
            _buildTableCell(_genm1totalControllers[2],2,'null'),
          ],
        ),
      ],
    );
      ...
      children: [
        ...
        Row(
          children: [
            ...
            _buildTableCell(_powerControllers[0],0,'nl'),
          ],
        ),
        Row(
          children: [
            _buildTableHeaderCell('KWH'),
            _buildTableCell(_powerControllers[1],1,'nl'),
          ],
        ),
        Row(
          children: [
            _buildTableHeaderCell('KVARH'),
            _buildTableCell(_powerControllers[2],2,'nl'),
          ],
        ),
      ],
    );
