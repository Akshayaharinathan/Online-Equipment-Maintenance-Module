...
import 'wc11_checklist.dart';
import 'wc11_measurement.dart';




class wc11 extends StatelessWidget {
  @override
                ...
                children: <Widget>[
                  ...
                  ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => wc11ChecklistPage()),
                      );
                    },
                  ...
                  ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => WC11MeasurementPage()),
                      );
                    },
                    style: ElevatedButton.styleFrom(
                      backgroundColor: Colors.lightGreen,
