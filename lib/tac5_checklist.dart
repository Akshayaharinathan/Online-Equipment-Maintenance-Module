...
class Tac5ChecklistPage extends StatefulWidget {
  @override
  _Tac5ChecklistPageState createState() => _Tac5ChecklistPageState();
}

class _Tac5ChecklistPageState extends State<Tac5ChecklistPage> {
  final _acNumberController = TextEditingController(text: 'Air Chiller 4');
  ...
  Future<void> _handleSubmit() async {
    ...
    await MongoDatabase.insert(checklistData, 'Air Chiller 4 Checklist');
