...
class TSolarChecklistPage extends StatefulWidget {
  @override
  _TSolarChecklistPageState createState() => _TSolarChecklistPageState();
}

class _TSolarChecklistPageState extends State<TSolarChecklistPage> {
  final _DGNumberController = TextEditingController(text: 'Solar Panel');
  final _dgunitController = TextEditingController(text: '200 KW');
  ...
  final _dgbranchController = TextEditingController(text: 'THUSMA');
  final _dgremarksControllers =
      List<TextEditingController>.generate(15, (_) => TextEditingController());

  final List<bool> _isYesChecked = List<bool>.generate(15, (_) => false);
  final List<bool> _isNoChecked = List<bool>.generate(15, (_) => false);
  ...
  Future<void> _handleSubmit() async {
    ...
    await MongoDatabase.insert(checklistData, 'Solar Checklist');
      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              _buildTextField(_DGNumberController, 'Panel', readOnly: true),
