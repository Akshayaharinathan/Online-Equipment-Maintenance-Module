...
import './dbHelper/mongodbthusma.dart'; // Ensure this import is correct
import 'package:intl/intl.dart';
import 'package:flutter/services.dart';


class Tconmespage extends StatefulWidget {
  @override
  _TconmespageState createState() => _TconmespageState();
}

class _TconmespageState extends State<Tconmespage> {
  final _transformerNumberController = TextEditingController(text: 'Control Panel');
  final _unitController = TextEditingController(text: 'Unit 4');
...
final _maxValues = {
  'output2': [
    300.0, 500.0, 500.0, 500.0, 440.0, 75.0, 75.0, 75.0, 75.0, 75.0,
    75.0, 75.0, 75.0, 40.0, 40.0, 40.0, 40.0, 150.0, 150.0, 150.0,
    150.0, 150.0, 150.0/*, 150.0, 60.0, 20.0, 200.0, 40.0, 20.0, 75.0,
    15.0, 25.0, 60.0, 15.0, 5.0, 15.0, 15.0, 15.0, 15.0, 75.0,
    25.0, 5.0, 15.0, 10.0, 15.0, 15.0, 15.0*/
  ],
};
...
void dispose() {
    ...
    try {
      ...
      final measurementData = {
        ...
        'controPanel':{
          ...
          'CP1 Section7Current': _outputControllers[11].text,
          'Cp1 SmallRollerCurrent': _outputControllers[12].text,
      ...
      await MongoDatabase.insert(measurementData, 'Control Panel Measurement');
      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              _buildTextField(_transformerNumberController, 'Control Number', readOnly: true),
  ...
  Widget _buildVoltageTable() {
    ...
    /*    Row(
          children: [
            _buildTableHeaderCell('Small Roller Current'),
            _buildTableCell(_outputControllers[23]),
          ],
        ),  */
       /* Row(
          children: [
