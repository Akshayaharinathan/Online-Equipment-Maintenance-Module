...
class Generator1ChecklistPage extends StatefulWidget {
  @override
  _Generator1ChecklistPageState createState() =>
      _Generator1ChecklistPageState();
}

class _Generator1ChecklistPageState extends State<Generator1ChecklistPage> {
  ...
  Future<void> _handleSubmit() async {
    ...
    await MongoDatabase.insert(checklistData, 'Generator 1 Checklist');
          ...
          child: Column(
            ...
            children: [
              _buildTextField(_Generator1NumberController, 'Generator Number',
                  readOnly: true),
              _buildTextField(_gen1unitController, 'New', readOnly: false),
