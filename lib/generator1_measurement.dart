...
class Generator1MeasurementPage extends StatefulWidget {
  @override
  _Generator1MeasurementPageState createState() =>
      _Generator1MeasurementPageState();
}

class _Generator1MeasurementPageState extends State<Generator1MeasurementPage> {
...
void dispose() {
  ...
  Future<void> _handleSubmit() async {
    try {
      ...
      await MongoDatabase.insert(measurementData, 'Generator 1 Measurement');
          ...
          child: Column(
            ...
            children: [
              ...
              _buildTextField(_GeneratorNumberController, 'Generator Number',
                  readOnly: true),
              _buildTextField(_genm1unitController, 'New', readOnly: false),
