...
class conChecklist2Page extends StatefulWidget {
  @override
  _conChecklist2PageState createState() => _conChecklist2PageState();
}

class _conChecklist2PageState extends State<conChecklist2Page> {
  ...
  Future<void> _handleSubmit() async {
    ...
    await MongoDatabase.insert(checklistData, 'Control Panel Unit 2 Checklist');
