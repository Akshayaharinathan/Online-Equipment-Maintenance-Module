...
class Generator3ChecklistPage extends StatefulWidget {
  @override
  _Generator3ChecklistPageState createState() =>
      _Generator3ChecklistPageState();
}

class _Generator3ChecklistPageState extends State<Generator3ChecklistPage> {
  ...
  Future<void> _handleSubmit() async {
    ...
    await MongoDatabase.insert(checklistData, 'Generator 3 Checklist');
          ...
          child: Column(
            ...
            children: [
              _buildTextField(_Generator1NumberController, 'Generator Number',
                  readOnly: true),
              _buildTextField(_gen1unitController, 'Unit', readOnly: false),
