...
class TconChecklistPage extends StatefulWidget {
  @override
  _TconChecklistPageState createState() => _TconChecklistPageState();
}

class _TconChecklistPageState extends State<TconChecklistPage> {
  ...
  final _remarksControllers = List<TextEditingController>.generate(13, (_) => TextEditingController());
  ...
  Future<void> _handleSubmit() async {
    ...
    await MongoDatabase.insert(checklistData, 'Control Panel Checklist');
