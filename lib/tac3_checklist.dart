...
class Tac3ChecklistPage extends StatefulWidget {
  @override
  _Tac3ChecklistPageState createState() => _Tac3ChecklistPageState();
}

class _Tac3ChecklistPageState extends State<Tac3ChecklistPage> {
  final _acNumberController = TextEditingController(text: 'Air Chiller 2');
  ...
  Future<void> _handleSubmit() async {
    ...
    await MongoDatabase.insert(checklistData, 'Air Chiller 2 Checklist');
