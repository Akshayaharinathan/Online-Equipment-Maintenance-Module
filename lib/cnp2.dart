...
import 'conChecklist2page.dart';
import 'cnpmeasurement2.dart';

class cn2Page extends StatelessWidget {
  @override
    ...
    height: 100.0,
              ...
              ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => conChecklist2Page()),
                  );
                },
