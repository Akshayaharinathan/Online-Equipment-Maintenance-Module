...
import 'conChecklist3page.dart';
import 'cnpmeasurement3.dart';

class cn3Page extends StatelessWidget {
  @override
    ...
    height: 100.0,
              ...
              ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => conChecklist3Page()),
                  );
                },
              ...
              ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => Unit3Page()),
                  );
                },
                style: ElevatedButton.styleFrom(
                  backgroundColor: Colors.lightGreen,
