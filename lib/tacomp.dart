...
import 'tacomp_checklist.dart';
import 'tacomp_measurement.dart';


class Tacomp extends StatelessWidget {
  @override
        ...
        child: Center(
          child: Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                Image.asset(
                  'assets/png_images/aircompressor.png', // Replace with your custom icon path
                  height: 100.0,
                ),
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => TacompChecklistPage()),
                    );
                  },
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => TacompMeasurementPage()),
                    );
                  },
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Colors.lightGreen,
