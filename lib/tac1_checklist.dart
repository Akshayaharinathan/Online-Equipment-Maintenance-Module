...
class Tac1ChecklistPage extends StatefulWidget {
  @override
  _Tac1ChecklistPageState createState() => _Tac1ChecklistPageState();
}

class _Tac1ChecklistPageState extends State<Tac1ChecklistPage> {
  final _acNumberController = TextEditingController(text: 'Air Chiller 1');
  final _acUnitController = TextEditingController(text: '7.5 KW');
  ...
  Future<void> _handleSubmit() async {
    ...
    await MongoDatabase.insert(checklistData, 'Air Chiller 1 Checklist');
