...
class acomp1MeasurementPage extends StatefulWidget {
  @override
  _acomp1MeasurementPageState createState() => _acomp1MeasurementPageState();
}

class _acomp1MeasurementPageState extends State<acomp1MeasurementPage> {
  ...
  print('Form Valid: $_isFormValid');
   ...
   Future<void> _handleSubmit(BuildContext context) async {
    try {
      ...
      await MongoDatabase.insert(measurementData, 'Air Compressor Unit 1 Measurement');
