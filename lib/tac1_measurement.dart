...
class Tac1MeasurementPage extends StatefulWidget {
  @override
  _Tac1MeasurementPageState createState() => _Tac1MeasurementPageState();
}

class _Tac1MeasurementPageState extends State<Tac1MeasurementPage> {
  final TextEditingController _ACMNumberController = TextEditingController(text:'Air Chiller');
  final TextEditingController _acmunitController = TextEditingController(text:'7.5 KW');
...
void dispose() {
  ...
  Future<void> _handleSubmit(BuildContext context) async {
    try {
      ...
      await MongoDatabase.insert(measurementData, 'Air Chiller 1 Measurement');
