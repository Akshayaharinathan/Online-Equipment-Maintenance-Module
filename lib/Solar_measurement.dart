...
class SolarMeasurementPage extends StatefulWidget {
  @override
  _SolarMeasurementPageState createState() => _SolarMeasurementPageState();
}

class _SolarMeasurementPageState extends State<SolarMeasurementPage> {
  final _transformerNumberController =
      TextEditingController(text: 'Solar Panel');
  final _unitController = TextEditingController(text: '300 KW');
