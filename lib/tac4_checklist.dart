...
class Tac4ChecklistPage extends StatefulWidget {
  @override
  _Tac4ChecklistPageState createState() => _Tac4ChecklistPageState();
}

class _Tac4ChecklistPageState extends State<Tac4ChecklistPage> {
  final _acNumberController = TextEditingController(text: 'Air Chiller 3');
  final _acUnitController = TextEditingController(text: '46.83 KW');
  ...
  final _acBranchController = TextEditingController(text: 'THUSMA');
  ...
  Future<void> _handleSubmit() async {
    ...
    await MongoDatabase.insert(checklistData, 'Air Chiller 3 Checklist');
