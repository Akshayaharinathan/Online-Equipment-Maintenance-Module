...
import 'tcp_checklist.dart';
import 'tcp_measurement.dart';



class TcnPage extends StatelessWidget {
  @override
              ...
              children: <Widget>[
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => TconChecklistPage()),
                    );
                  },
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => Tconmespage()),
                    );
                  },
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Colors.lightGreen,
