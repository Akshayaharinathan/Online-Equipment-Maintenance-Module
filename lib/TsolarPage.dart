...
import 'TSolar_checklist.dart';
import 'TSolar_measurement.dart';


class TsolarPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
       ...
       children: <Widget>[
         Image.asset('assets/png_images/solar.png', height: 100.0),
       SizedBox(height: 20.0),
              ...
              ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => TSolarChecklistPage()),
                  );
                },
              ...
              ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => TSolarMeasurementPage()),
                  );
                },
                style: ElevatedButton.styleFrom(
                  backgroundColor: Colors.lightGreen,
