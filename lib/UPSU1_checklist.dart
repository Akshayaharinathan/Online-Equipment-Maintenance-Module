...
class UPSU1ChecklistPage extends StatefulWidget {
  @override
  _UPSU1ChecklistPageState createState() => _UPSU1ChecklistPageState();
}


class _UPSU1ChecklistPageState extends State<UPSU1ChecklistPage> {
  final _upsu1NumberController = TextEditingController(text: 'UPS-200kva');
  final _upsu1unitController = TextEditingController(text: 'unit 1');
  ...
  Future<void> _handleSubmit() async {
    ...
    final checklistData = {
      'ups u1 Number': _upsu1NumberController.text,
    ...
    await MongoDatabase.insert(checklistData, 'UPS 1 Unit 1 Checklist');
