...
class _MeasurementPageState extends State<MeasurementPage> {
  final _transformerNumberController = TextEditingController(text: '1250KVA');
  ...
  final _maxValues = {
    'volt': [70.0, 70.0, 70.0],
    'curr': [1250.0, 1250.0, 1250.0],
    'pre': [0.95, 0.95, 0.50, 1.0, 1.0, 52.0],
  };
      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              _buildTextField(
                  _transformerNumberController, 'Transformer Number',
                  readOnly: true),
