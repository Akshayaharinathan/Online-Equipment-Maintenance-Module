...
import './dbHelper/mongodbjsb.dart'; // Assume this is your MongoDB database handling file
import 'dart:async'; // Add this import for the Timer

class MVChecklistPage extends StatefulWidget {
  @override
  _MVChecklistPageState createState() => _MVChecklistPageState();
}

class _MVChecklistPageState extends State<MVChecklistPage> {
  final _MVNumberController = TextEditingController(text: 'MV Panel-2500 A/4P');
  ...
  final _mvbranchController = TextEditingController(text: 'JSB');
