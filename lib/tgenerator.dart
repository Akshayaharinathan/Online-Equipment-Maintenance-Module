...
import 'tgenerator_checklist.dart';
import 'tgenerator_measurement.dart';

class TGeneratorPage extends StatelessWidget {
  @override
              ...
              children: <Widget>[
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => TGeneratorChecklistPage()),
                    );
                  },
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => TGeneratorMeasurementPage()),
                    );
                  },
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Colors.lightGreen,
