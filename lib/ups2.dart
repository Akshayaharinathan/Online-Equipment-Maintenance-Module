...
import 'UPSU2_checklist.dart';
import 'UPSU2_measurement.dart';

class UPSU2 extends StatelessWidget {
  @override
                ...
                children: <Widget>[
                  ...
                  ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => UPSU2ChecklistPage()),
                      );
                    },
                  ...
                  ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => UPSU2MeasurementPage()),
                      );
                    },
                    style: ElevatedButton.styleFrom(
                      backgroundColor: Colors.lightGreen,
