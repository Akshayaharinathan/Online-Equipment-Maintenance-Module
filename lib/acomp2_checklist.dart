...
class acomp2ChecklistPage extends StatefulWidget {
  @override
  _acomp2ChecklistPageState createState() => _acomp2ChecklistPageState();
}

class _acomp2ChecklistPageState extends State<acomp2ChecklistPage> {
  ...
  Future<void> _handleSubmit() async {
    ...
    await MongoDatabase.insert(checklistData, 'Air Compressor Unit 2 Checklist');
