...
class UPSU2ChecklistPage extends StatefulWidget {
  @override
  _UPSU2ChecklistPageState createState() => _UPSU2ChecklistPageState();
}

class _UPSU2ChecklistPageState extends State<UPSU2ChecklistPage> {
  ...
  Future<void> _handleSubmit() async {
    ...
    final checklistData = {
      'ups u2 Number': _upsu1NumberController.text,
    ...
    await MongoDatabase.insert(checklistData, 'UPS 1 Unit 2 Checklist');
