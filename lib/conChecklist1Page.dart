...
class conChecklist1Page extends StatefulWidget {
  @override
  _conChecklist1PageState createState() => _conChecklist1PageState();
}

class _conChecklist1PageState extends State<conChecklist1Page> {
  ...
  Future<void> _handleSubmit() async {
    ...
    await MongoDatabase.insert(checklistData, 'Control Panel Unit 1 Checklist');
