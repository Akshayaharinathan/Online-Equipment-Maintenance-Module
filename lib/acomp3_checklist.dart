...
class acomp3ChecklistPage extends StatefulWidget {
  @override
  _acomp3ChecklistPageState createState() => _acomp3ChecklistPageState();
}

class _acomp3ChecklistPageState extends State<acomp3ChecklistPage> {
  ...
  Future<void> _handleSubmit() async {
    ...
    await MongoDatabase.insert(checklistData, 'Air Compressor Unit 3 Checklist');
