...
class TGeneratorChecklistPage extends StatefulWidget {
  @override
  _TGeneratorChecklistPageState createState() => _TGeneratorChecklistPageState();
}

class _TGeneratorChecklistPageState extends State<TGeneratorChecklistPage> {
  final _GeneratorNumberController =TextEditingController(text: 'Generator-600kva');
  final _gen1unitController = TextEditingController(text: 'Unit 4');

  final _gen1dateController = TextEditingController();
  final _gen1timeController = TextEditingController();
  final _gen1branchController = TextEditingController(text: 'THUSMA');
  ...
  void _validateFields() {
    bool allFieldsFilled = _GeneratorNumberController.text.isNotEmpty &&
  ...
  Future<void> _handleSubmit() async {
    ...
    await MongoDatabase.insert(checklistData, 'Generator Checklist');
      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              _buildTextField(_GeneratorNumberController, 'Generator Number',readOnly: true),
              _buildTextField(_gen1unitController, 'Unit', readOnly: true),
