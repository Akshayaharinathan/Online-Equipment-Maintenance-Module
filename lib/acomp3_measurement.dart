...
class acomp3MeasurementPage extends StatefulWidget {
  @override
  _acomp3MeasurementPageState createState() => _acomp3MeasurementPageState();
}

class _acomp3MeasurementPageState extends State<acomp3MeasurementPage> {
  final TextEditingController _transformerNumberController =
      TextEditingController(text: 'Air Compressor 3');
  ...
  print('Form Valid: $_isFormValid');
   ...
   Future<void> _handleSubmit(BuildContext context) async {
    try {
      ...
      await MongoDatabase.insert(measurementData, 'Air Compressor Unit 3 Measurement');
