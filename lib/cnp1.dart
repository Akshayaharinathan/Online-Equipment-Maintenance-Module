...
import 'conChecklist1Page.dart';
import 'cnpmeasurement1.dart';
class cn1Page extends StatelessWidget {
  @override
    ...
    height: 100.0,
              ...
              ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => conChecklist1Page()),
                  );
                },
              ...
              ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => Unit1Page()),
                  );
                },
                style: ElevatedButton.styleFrom(
                  backgroundColor: Colors.lightGreen,
