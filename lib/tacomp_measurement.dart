...
class TacompMeasurementPage extends StatefulWidget {
  @override
  _TacompMeasurementPageState createState() => _TacompMeasurementPageState();
}

class _TacompMeasurementPageState extends State<TacompMeasurementPage> {
  final TextEditingController _transformerNumberController =
      TextEditingController(text: 'Air Compressor');
  ...
  final TextEditingController _branchController =
      TextEditingController(text: 'THUSMA');
  ...
  final  _time1Controllers =List.generate(2, (_) => TextEditingController());
  final  _time2Controllers =List.generate(2, (_) => TextEditingController());
  final  _time3Controllers =List.generate(2, (_) => TextEditingController());
...
final _maxValuesInt = {
  ...
  final time1Valid = _validateFieldGroup(
    _time1Controllers,
    _minValuesInt['time1']!,
    maxValues: _maxValuesInt['time1'],
    isInteger: true,
  );
  final time2Valid = _validateFieldGroup(
    _time2Controllers,
    _minValuesInt['time2']!,
    maxValues: _maxValuesInt['time2'],
    isInteger: true,
  );
  final time3Valid = _validateFieldGroup(
    _time3Controllers,
    _minValuesInt['time3']!,
    maxValues: _maxValuesInt['time3'],
    isInteger: true,
  );
    ...
    try {
      ...
      final measurementData = {
        ...
        'Run Unload':{
          ...
          'Seconds': _time1Controllers[1].text
          } ,
        'Run Load':{
          'Minutes': _time2Controllers[0].text, 
          'Seconds': _time2Controllers[1].text
        },
        'Stand BY': {
          'Minutes': _time3Controllers[0].text,
          'Seconds': _time3Controllers[0].text
        },
      ...
      await MongoDatabase.insert(measurementData, 'Air Compressor Measurement');
          ...
          child: Column(
            ...
            children: [
             ...
             // _buildTextField(_referenceNumberController, 'Reference Number',readOnly: true),
              ...
              _buildOutputTable(),
              SizedBox(height: 20.0),
              _buildSectionHeader('SERVICE HOURS'),
              _buildBatteryTable(),
              Center(
      ...
      children: [
        ...
        Row(
          children: [
            ...
            _buildTableCell(_time1Controllers[1],1,'time1'),
          ],
        ),
        Row(
          children: [
        ...
        Row(
          children: [
            _buildTableHeaderCell('Seconds'),
            _buildTableCell(_time2Controllers[1],1,'time2'),
          ],
        ),
        Row(
          children: [
        ...
        Row(
          children: [
            _buildTableHeaderCell('Seconds'),
            _buildTableCell(_time3Controllers[1],1,'time3'),
          ],
        ),
        Row(
          children: [
        ...
        Row(
          children: [
            _buildTableHeaderCell('Run Hours'),
  ...
  if (type.startsWith('time')) {
    minValue = _minValuesInt[type]?[index] ?? 0;
    maxValue = _maxValuesInt[type]?[index] ?? double.infinity;
  } else {
