...
import 'tmv_checklist.dart';
import 'tmv_measurement.dart';

class TmvPage extends StatelessWidget {
  @override
        ...
        child: Center(
          child: Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                Image.asset(
                  'assets/png_images/mvpanel.png', // Replace with your custom icon path
                  height: 100.0,
                ),
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => TMVChecklistPage()),
                    );
                  },
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => TMVMeasurementPage()),
                    );
                  },
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Colors.lightGreen,
