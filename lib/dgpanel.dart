...
import 'dg_checklist.dart';
import 'dg_measurement.dart';


class DGPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
       ...
       children: <Widget>[
         Image.asset('assets/png_images/dgpanel.png', height: 100.0),
       SizedBox(height: 20.0),
              ...
              ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => DGChecklistPage()),
                  );
                },
              ...
              ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => DGMeasurementPage()),
                  );
                },
                style: ElevatedButton.styleFrom(
                  backgroundColor: Colors.lightGreen,
