...
class SolarChecklistPage extends StatefulWidget {
  @override
  _SolarChecklistPageState createState() => _SolarChecklistPageState();
}

class _SolarChecklistPageState extends State<SolarChecklistPage> {
  final _DGNumberController = TextEditingController(text: 'Solar Panel');
  final _dgunitController = TextEditingController(text: '300 KW');
