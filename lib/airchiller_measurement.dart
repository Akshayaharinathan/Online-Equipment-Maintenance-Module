...
class acMeasurementPage extends StatefulWidget {
  @override
  _acMeasurementPageState createState() => _acMeasurementPageState();
}

class _acMeasurementPageState extends State<acMeasurementPage> {
  final TextEditingController _ACMNumberController = TextEditingController(text:'Air Chiller');
  //final TextEditingController _acmunitController = TextEditingController();
  ...
  final _maxValues = {
    'out': [50.0, 20.0, 100.0, 100.0, 300.0, 100.0, 100.0, 100.0, 20.0],
  };
...
void dispose() {
  ...
  Future<void> _handleSubmit(BuildContext context) async {
    try {
      ...
      await MongoDatabase.insert(measurementData, 'Air Chiller Measurement');
