...
class UPSU4MeasurementPage extends StatefulWidget {
  @override
  _UPSU4MeasurementPageState createState() => _UPSU4MeasurementPageState();
}

class _UPSU4MeasurementPageState extends State<UPSU4MeasurementPage> {
  ...
  final TextEditingController _unitController =
      TextEditingController(text: 'unit 3');
...
void dispose() {
  ...
  Future<void> _handleSubmit() async {
    try {
      ...
      await MongoDatabase.insert(measurementData, 'UPS 1 Unit 3 Measurement');
