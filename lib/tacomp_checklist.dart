...
class TacompChecklistPage extends StatefulWidget {
  @override
  _TacompChecklistPageState createState() => _TacompChecklistPageState();
}

class _TacompChecklistPageState extends State<TacompChecklistPage> {
  ...
  final _acomp2branchController = TextEditingController(text: 'THUSMA');
  ...
  Future<void> _handleSubmit() async {
    ...
    await MongoDatabase.insert(checklistData, 'Air Compressor Checklist');
