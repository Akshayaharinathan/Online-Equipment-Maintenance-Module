...
class TUPSMeasurementPage extends StatefulWidget {
  @override
  _TUPSMeasurementPageState createState() => _TUPSMeasurementPageState();
}

class _TUPSMeasurementPageState extends State<TUPSMeasurementPage> {
  final TextEditingController _transformerNumberController =
      TextEditingController(text: 'UPS-400kva');
  //final TextEditingController _unitController =TextEditingController(text: 'unit 4');
...
void dispose() {
  ...
  Future<void> _handleSubmit() async {
    try {
      ...
      await MongoDatabase.insert(measurementData, 'UPS Measurement');
      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              _buildTextField(_transformerNumberController, 'UPS Number'),
              //_buildTextField(_unitController, 'Unit'),
              _buildTextField(_dateController, 'Date and Day'),
              _buildTextField(_timeController, 'Timing'),
