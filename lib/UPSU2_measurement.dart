...
class UPSU2MeasurementPage extends StatefulWidget {
  @override
  _UPSU2MeasurementPageState createState() => _UPSU2MeasurementPageState();
}

class _UPSU2MeasurementPageState extends State<UPSU2MeasurementPage> {
...
void dispose() {
  ...
  Future<void> _handleSubmit() async {
    try {
      ...
      await MongoDatabase.insert(measurementData, 'UPS 1 Unit 2 Measurement');
