...
class MVMeasurementPage extends StatefulWidget {
  @override
  _MVMeasurementPageState createState() => _MVMeasurementPageState();
}

class _MVMeasurementPageState extends State<MVMeasurementPage> {
  final _mvmunitController = TextEditingController(text: 'MV Panel-2500 A/4P');
  final _mvmdateController = TextEditingController();
  final _mvmtimeController = TextEditingController();
  final _mvmbranchController = TextEditingController(text: 'JSB');
...
void dispose() {
  ...
  void _validateForm() {
    ...
    print('phaseangle Valid: $pa4Valid');
    print('phaseangle Valid: $pa5Valid');
    print('phaseangle Valid: $pa6Valid');
    print('%THD: $L1Valid');
    ...
    try {
      ...
      final measurementData = {
        ...
        'CurrentOutput': {
          ...
          'Current Line R': _mvmcurrentControllers[0].text,
          'Current Line Y': _mvmcurrentControllers[1].text,
          'Current Line B': _mvmcurrentControllers[2].text,
      ...
      await MongoDatabase.insert(measurementData, 'MV Measurement');
