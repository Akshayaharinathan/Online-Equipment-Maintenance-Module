...
class UPSU4ChecklistPage extends StatefulWidget {
  @override
  _UPSU4ChecklistPageState createState() => _UPSU4ChecklistPageState();
}

class _UPSU4ChecklistPageState extends State<UPSU4ChecklistPage> {
  final _upsu1NumberController = TextEditingController(text: 'UPS-400kva');
  final _upsu1unitController = TextEditingController(text: 'unit 3');
  ...
  Future<void> _handleSubmit() async {
    ...
    final checklistData = {
      'ups u4 Number': _upsu1NumberController.text,
    ...
    await MongoDatabase.insert(checklistData, 'UPS 1 Unit 3 Checklist');
